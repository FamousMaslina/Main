...
def main():
  ...
  for file in python_files:
    if os.path.basename(file) != "identifier.py"  and os.path.basename(file) != "perftest.py" and os.path.basename(file) != "op2api.py":
...
def main2():
  ...
  python_files = find_python_files(directory)
  for file in python_files:
    if os.path.basename(file) != "identifier.py" and os.path.basename(file) != "op2.py" and os.path.basename(file) != "bios.py"  and os.path.basename(file) != "perftest.py" and os.path.basename(file) != "op2api.py" and os.path.basename(file) != "idmb.py":
