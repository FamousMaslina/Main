...
while count <5:
    ...
    if os == "over":
        ...
        print()
        print(ver, "- Removed 'beep.mp3'")
        print("Added clock")
        print("Added shutdown or exit")
        print("The Check thingy was moved to an external application like write and others")
        print()
    elif os == "crd":
    ...
    #external apps
        ...
        if opticonf["chkstart"] == "1":
            ...
            print("Value may be the same or incorrect")
            print()
    elif os == "enable startup check":
        print()
