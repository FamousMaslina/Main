...
if playerChoice == "about":
    print("PyOS V1.4. Python Version 3.9.5'")
    playerChoice = input("P:\Python ")
...
#=============================================================
    playerChoice = input("P:\Python ")
elif playerChoice == "disclaimer":
    print("At every command typed after that P:\Python, you need to restart the launcher")
    playerChoice = input("P:\Python ")
    ...
    print("Installing")
    time.sleep(1)
    input("Something happend. Please restart youre system. Reason: Potential UnWanted Program")
    ...
    input("Restart your system due to security reasons")
    ...
    if playerChoice == "1":
        ...
        playsound('bass.mid')
    playerChoice = input("P:\Python ")
elif playerChoice == "clock":
    now = datetime.now()

    current_time = now.strftime("%H:%M:%S")
    print("Current Time =", current_time)
    playerChoice = input("P:\Python\Programs\clock1.0 ")
