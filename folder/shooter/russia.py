...
rx = random.randint(0, 250)
ry = random.randint(0, 25)
russia7 = enemy('assets/shooter/su57.png', rx, ry)
rx = random.randint(0, 250)
ry = random.randint(0, 25)
russia8 = enemy('assets/shooter/su57.png', rx, ry)
rx = random.randint(0, 250)
ry = random.randint(0, 25)
russia9 = enemy('assets/shooter/su57.png', rx, ry)
rx = random.randint(0, 225)
ry = random.randint(0, 25)
russia10 = enemy('assets/shooter/su57.png', rx, ry)
rx = random.randint(0, 250)
ry = random.randint(0, 25)
russia11 = enemy('assets/shooter/su57.png', rx, ry)
rx = random.randint(0, 250)
ry = random.randint(0, 25)
russia12 = enemy('assets/shooter/su57.png', rx, ry)
